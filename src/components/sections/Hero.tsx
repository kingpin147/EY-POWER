...
export function Hero() {
    return (
        <section className="relative w-full min-h-[90vh] lg:h-[85vh] flex items-center overflow-hidden bg-black text-white pt-20 lg:pt-0">
            {/* Background overlay/texture */}
            <div className="absolute inset-0 opacity-10 bg-[url('/grid-texture.png')] bg-repeat pointer-events-none" />

            <div className="container mx-auto px-4 md:px-6 relative z-10 grid lg:grid-cols-2 gap-12 items-center py-12 lg:py-0">
                <div className="space-y-6 text-center lg:text-left">
                    <div className="inline-block px-3 py-1 bg-accent/20 border border-accent/30 text-accent text-[10px] md:text-sm font-medium tracking-widest uppercase rounded-full">
                        Engineering-Driven Reliability
                    </div>
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading font-black leading-[1.1] tracking-tighter">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-center lg:justify-start">
                        ...
                        <Link href="/applications#inquire" className="w-full sm:w-auto">
                            <Button size="lg" variant="outline" className="w-full sm:w-auto border-accent text-accent hover:bg-accent hover:text-black font-bold px-10 h-14">
                ...
                <div className="relative h-[300px] md:h-[450px] lg:h-[550px] flex items-center justify-center">
